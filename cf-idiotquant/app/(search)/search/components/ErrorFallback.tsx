    ...
    <div className="flex flex-col items-center justify-center py-24 px-6 text-center animate-in fade-in zoom-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full max-w-xs sm:max-w-none justify-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-white dark:bg-surface-dark-card border border-neutral-200 dark:border-border-subtle-dark text-neutral-700 dark:text-neutral-300 rounded-2xl font-bold hover:bg-[#f5f1eb] dark:hover:bg-surface-dark-muted transition-all active:scale-95"
        >
          <RotateCw size={18} />
          페이지 새로고침
        </button>
      ...
      <div className="mt-16 flex flex-col items-center gap-2">
        <div className="h-px w-12 bg-neutral-200 dark:bg-surface-dark-muted" />
