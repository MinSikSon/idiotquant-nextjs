    ...
    if (isUs) {
        return (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <Section title="US NCAV 청산가치 전략" className="dark:!bg-zinc-400 rounded-xl overflow-hidden">
                    <SectionCard className="dark:!bg-zinc-950">
                        <MdTableTemplate content={calculateUsNcav(data.finnhubData, data.usDetail)} />
                    </SectionCard>
                </Section>
                <Section title="US S-RIM 적정주가 전략" className="dark:!bg-zinc-400 rounded-xl overflow-hidden">
                    <SectionCard className="dark:!bg-zinc-950">
