...
export const StockHeader = ({ data, isUs, isFixed }: StockHeaderProps) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-white dark:bg-surface-dark-card border-neutral-200 dark:border-border-subtle-dark transition-all",
          isFixed 
            ? "rounded-none border-b shadow-lg backdrop-blur-md bg-white/90 dark:bg-surface-dark/90" 
          ...
          <div className="flex items-center gap-4 flex-none">
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-bold bg-[#f0fdf4] text-brand dark:bg-[#14532d]/30 dark:text-brand uppercase tracking-tighter">
                  {config.marketName}
                </span>
              </div>
              <div className="flex items-baseline gap-1">
                <span className={cn(
                  "font-mono font-black text-brand dark:text-brand transition-all",
