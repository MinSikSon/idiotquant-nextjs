...
// import { selectStrategyTableRow, selectStrategyFinancialDate, selectStrategyMarketDate,  } from "@/lib/features/strategy/strategySlice";

export default function Item({ params: { id } }: { params: { id: number } }) {
    const strategyInfoList = useAppSelector(getStrategyInfoList);
    // console.log(`strategyInfoList`, strategyInfoList);
