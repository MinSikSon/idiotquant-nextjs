    ...
    <section className="border-b border-neutral-100 dark:border-[#1c2f26] bg-white dark:bg-[#0a1510]/85">
      <div className="max-w-4xl mx-auto px-5 py-10">
        ...
        <div className="flex items-end justify-between gap-3 mb-3.5">
          ...
          <Link
            href="/screener"
            className="inline-flex items-center min-h-[44px] px-2 -mx-2 text-[11.5px] font-bold text-brand dark:text-[#22c55e] hover:opacity-70 transition-opacity shrink-0"
          >
          ...
          {isLoading && top.length === 0 ? (
            ...
            <div>
              {top.map(item => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="hidden sm:block text-[13px] font-mono font-extrabold tabular-nums text-brand dark:text-[#4ade80] text-right">
              ...
              {rest > 0 && (
                <Link
                  href="/screener"
                  className="block px-[18px] py-3 bg-surface-canvas dark:bg-[#0c1712] text-center text-[11.5px] font-bold text-brand dark:text-[#22c55e] hover:opacity-70 transition-opacity"
                >
                  나머지 {rest}개 종목 보기 →
                </Link>
              )}
