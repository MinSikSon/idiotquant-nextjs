...
export default function ProfilePage() {
    ...
    if (status === "loading") {
        return (
            <div className="min-h-screen bg-stone-100 dark:bg-[#0d0d0d] flex items-center justify-center">
                <div className="w-8 h-8 rounded-full border-2 border-neutral-300 border-t-blue-600 animate-spin" />
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-stone-100 dark:bg-[#0d0d0d] px-4 py-8 md:py-12">
            <div className="mx-auto max-w-sm space-y-4">
                ...
                {/* Profile card */}
                <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-neutral-200/70 dark:border-[#2a2a2a] shadow-sm overflow-hidden">
                    <div className="flex items-center gap-4 px-5 py-5">
                        <div className="w-12 h-12 rounded-full bg-neutral-200 dark:bg-[#3a3a3a] flex items-center justify-center text-neutral-700 dark:text-neutral-200 text-base font-black shrink-0">
                            {initial}
                        </div>
                        <div className="min-w-0">
                            ...
                            {isMasterUser && (
                                <span className="inline-block mt-1 text-[9px] font-extrabold px-1.5 py-0.5 rounded bg-blue-100 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400 uppercase tracking-tight">
                                    Admin
                                </span>
                            )}
                        </div>
                ...
                {isMasterUser && (
                    <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-neutral-200/70 dark:border-[#2a2a2a] shadow-sm overflow-hidden">
                        ...
                        <div className="divide-y divide-neutral-100 dark:divide-[#2a2a2a]">
                            <Link
                                href="/balance-kr"
                                className="flex items-center gap-3 px-5 py-3.5 hover:bg-stone-50 dark:hover:bg-[#1f1f1f] transition-colors group"
                            >
                                <div className="w-8 h-8 rounded-xl bg-stone-100 dark:bg-[#2a2a2a] flex items-center justify-center shrink-0">
                ...
                <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl border border-neutral-200/70 dark:border-[#2a2a2a] shadow-sm overflow-hidden">
                    ...
                    >
                        <div className="w-8 h-8 rounded-xl bg-stone-100 dark:bg-[#2a2a2a] flex items-center justify-center shrink-0 group-hover:bg-red-100 dark:group-hover:bg-red-950/30 transition-colors">
