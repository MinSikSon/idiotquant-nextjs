    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6 bg-stone-50 dark:bg-[#0d0d0d] transition-colors duration-300">
      <div className="max-w-md w-full flex flex-col items-center text-center">
        ...
        <div className="relative mb-8">
          ...
          <div className="relative flex items-center justify-center w-24 h-24 rounded-3xl bg-white dark:bg-[#1a1a1a] border border-neutral-200 dark:border-[#2a2a2a] shadow-xl">
        ...
        <div className="space-y-6 mb-10">
          ...
          <div className="inline-block px-4 py-2 rounded-lg bg-neutral-200/50 dark:bg-[#2a2a2a]/50 border border-neutral-300 dark:border-[#3a3a3a]">
        ...
        <Link href="/" className="group relative">
          ...
          <button className="relative flex items-center justify-center gap-2 px-8 py-4 bg-white dark:bg-[#1a1a1a] text-neutral-900 dark:text-white rounded-xl font-bold border border-neutral-200 dark:border-[#2a2a2a] transition-all hover:scale-[1.02] active:scale-[0.98]">
        ...
        <div className="mt-16 pt-8 border-t border-dashed border-neutral-200 dark:border-[#2a2a2a] w-full">
