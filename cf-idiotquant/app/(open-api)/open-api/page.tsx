...
import { setKoreaInvestmentToken, KoreaInvestmentToken, KoreaInvestmentBalance } from "@/lib/features/koreaInvestment/koreaInvestmentSlice";
...
export default function OpenApi() {
    ...
    function reload(seq: any) {
        ...
        console.log(`[OpenApi] ${seq} kiToken`, kiToken);
        console.log(`[OpenApi] ${seq} loginState`, loginState);
        if ("init" != loginState) {
