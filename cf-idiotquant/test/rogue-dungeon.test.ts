...
test("층은 끊기지 않는다 — 방도 계단도 걸어서 닿는다", () => {
    // ── 어느 시드로 만들어도 모든 방이 서로 이어진다
    {
...
test("같은 시드는 같은 층이고, 방은 안 겹친다", () => {
    // ── 같은 시드는 같은 층을 만든다 — 재현이 안 되면 고장을 못 본다
    {
...
test("1층은 밝고, 지도 밖으로 새는 칸이 없다", () => {
    // ── 1층은 전부 밝은 방이다 — 처음 켠 사람이 지도를 본다
    {
