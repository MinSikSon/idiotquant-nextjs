...
test("나오는 장수는 **쇠붙이 몫 한 장과 강화분 사이**다", () => {
...
test("강화분은 **확률로** 돌아온다 — 다도 아니고 하나도 아니다", () => {
    let full = 0;
    let short = 0;
    let sum = 0;
    const runs = 400;
...
test("강화 없는 무기도 한 장은 나온다 — 그 한 장은 확률이 아니다", () => {
...
test("갑옷도 녹는다 — 나오는 것은 **갑옷** 강화 주문서다", () => {
