...
function PieTooltip({ active, payload }: { active?: boolean; payload?: any[] }) {
  ...
  return (
    <div className="bg-white dark:bg-[#35332e] px-3 py-2 rounded-lg border border-neutral-200 dark:border-[#4a4641] shadow-lg">
  ...
  if (pieData.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 gap-3">
        <div className="p-4 rounded-2xl bg-[#faf9f7] dark:bg-[#35332e]">
...
export function PortfolioChartSection({
  ...
  return (
    <>
      <div className="flex items-center gap-2 mb-6 bg-[#faf9f7] dark:bg-[#35332e] p-1 rounded-xl w-fit">
        <TabButton
