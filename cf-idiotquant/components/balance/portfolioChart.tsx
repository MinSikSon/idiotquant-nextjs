...
function PieTooltip({ active, payload }: { active?: boolean; payload?: any[] }) {
  ...
  return (
    <div className="bg-white dark:bg-surface-dark-muted px-3 py-2 rounded-lg border border-neutral-200 dark:border-[#4a4641] shadow-lg">
  ...
  if (pieData.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 gap-3">
        <div className="p-4 rounded-2xl bg-surface-canvas dark:bg-surface-dark-muted">
