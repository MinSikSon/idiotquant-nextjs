...
const MEDAL_TONE: Record<ValueTone, string> = {
    ...
    silver: "bg-neutral-100 text-neutral-600 ring-neutral-300 dark:bg-surface-dark-hover dark:text-neutral-300 dark:ring-[#4a4641]",
    ...
    explore: "bg-neutral-50 text-neutral-400 ring-neutral-200 dark:bg-surface-dark-card dark:text-neutral-500 dark:ring-[#35332e]",
};
