...
export const CODEX_ENTRIES: CodexEntry[] = [
    ...
    },
    {
        kind: "weapon",
        type: "mithril arrow",
        key: "weapon:mithril arrow",
        name: "미스릴 화살",
        category: "weapon",
        categoryLabel: "무기",
        masteryType: "kills",
        masteryGoal: 20,
        flavor: "미스릴로 촉을 두드린 화살. 가벼운데도 과녁에 닿으면 깊이 박힌다.",
        masteryFlavor: "푸른 빛줄기가 어둠을 가를 때마다 한 마리씩 쓰러졌다.",
    },
    {
        kind: "weapon",
        type: "oriharukon arrow",
        key: "weapon:oriharukon arrow",
        name: "오리하루콘 화살",
        category: "weapon",
        categoryLabel: "무기",
        masteryType: "kills",
        masteryGoal: 20,
        flavor: "전설의 금속 오리하루콘으로 벼린 화살. 시위를 떠나는 소리부터 다르다.",
        masteryFlavor: "가장 깊은 층의 괴물들도 이 화살 앞에서는 갑옷이 종잇장이었다.",
    },
    {
        kind: "weapon",
        type: "silver sword",
    ...
    },
    {
        ...
        masteryType: "uses",
        masteryGoal: 5,
        flavor: "진한 생명력이 농축된 포션. 막대한 체력을 회복하고 최대 체력을 크게 늘려 준다.",
    ...
    },
    {
        kind: "ring",
        type: "see invisible",
        key: "ring:see invisible",
        name: "투명 보기",
        category: "ring",
        categoryLabel: "반지",
        masteryType: "steps",
        masteryGoal: 1000,
        flavor: "시야를 비틀어 모습 없는 팬텀까지 드러낸다.",
        masteryFlavor: "보이지 않는 사냥꾼의 숨결까지 읽으며 어둠을 걸었다.",
    },
    {
        kind: "ring",
        type: "adornment",
        ...
        masteryType: "steps",
        masteryGoal: 1000,
        flavor: "눈부시게 아름다운 장신구. 원작처럼 점수로 10 gold의 값어치를 한다.",
        masteryFlavor: "아무런 힘도 없지만 어두운 미궁에서 손가락을 빛내 준 소박한 벗이다.",
    },
    {
        kind: "ring",
        type: "aggravate monsters",
        key: "ring:aggravate monsters",
        name: "몬스터 도발",
        category: "ring",
        categoryLabel: "반지",
        masteryType: "steps",
        masteryGoal: 1000,
        flavor: "저주받은 반지. 층의 모든 몬스터를 깨워 착용자를 향하게 만든다.",
        masteryFlavor: "미궁 전체의 적의를 한몸에 받으면서도 끝까지 살아남았다.",
    },
    {
        kind: "ring",
        type: "dexterity",
        ...
        masteryType: "steps",
        masteryGoal: 1000,
        flavor: "손끝의 감각을 높여 공격의 명중 보정을 준다.",
        masteryFlavor: "칼끝이 빈틈을 놓치지 않는 경지에 이르렀다.",
    },
    {
        kind: "ring",
        type: "increase damage",
        key: "ring:increase damage",
        name: "피해 증가",
        category: "ring",
        categoryLabel: "반지",
        masteryType: "steps",
