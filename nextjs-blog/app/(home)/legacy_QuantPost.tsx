...
// import BackTestingPanel from "../backtest/BackTestingPanel.jsx";

// export default async function QuantPost() {
//   console.log(`%c[call] QuantPost`, `color : white; background : blue`);
//   const investValues = await getInvestValues();
...
//   React.useEffect(() => {
//     const marketInfoPrevIndex = investValues.props.marketInfoList.length - 2;
//     const marketInfoLatestIndex = investValues.props.marketInfoList.length - 1;
//     const marketInfoPrev = investValues.props.marketInfoList[marketInfoPrevIndex];
//     const marketInfoLatest = investValues.props.marketInfoList[marketInfoLatestIndex];

//     if (!!investValues.props.financialInfoAll && !!marketInfoLatest) {
//       let dictNewFinancialInfoAll = changeStockCompanyName(investValues.props.financialInfoAll, "현대자동차", "현대차");
...
//     }
//   }, [investValues.props.financialInfoAll, investValues.props.marketInfoList.marketInfoLatest]);
...
//         bsnsDate: marketInfoLatest["date"],
//         ...investValues.props.financialInfoAll[stockCompanyName],
...
//         financialInfoList={investValues.props.financialInfoList}
//         marketInfoList={investValues.props.marketInfoList}
