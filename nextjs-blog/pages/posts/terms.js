    ...
    return (
        <main className="py-6 px-4 sm:p-6 md:py-10 md:px-8">
            <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                ...
                <p className="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 bg-gray-100 rounded-lg">
                    {detail}
                </p>
            </div>
        </main>
    ...
    return (
        <>
            <ul className='list-disc list-outside pb-4'>
                ...
                <li>EV: Enterprise Value. 기업가치. 실제 얼마를 투입하면 기업을 완전히 지배할 수 있는지 보여주는 지표.
                    <ul className='list-disc list-inside'>
                ...
                <li>GP/A = 매출총이익/총자산 = (매출액 - 매출원가) / (자기자본 + 대출(부채))
                    <ul className='list-disc list-inside'>
...
export default function TermsPost() {
    ...
    return (
        <>
            ...
            <Article title={`격언`} subTitle={<a href="https://namu.wiki/w/벤저민%20그레이엄">벤저민 그레이엄</a>} detail={<Graham />} img1={`https://upload.wikimedia.org/wikipedia/commons/2/2a/Benjamin_Graham_%281894-1976%29_portrait_on_23_March_1950.jpg`} img2={`https://i.namu.wiki/i/-Cbo5y4wR7mJhA5b_nY0mY0w4gqy_4VlAAt4IrZOqvCd4OeUF0g-BHjWeIjjpPU2Egm6gJ-Yr8kAigeE2_oS7w.webp`} img3={`https://image.yes24.com/goods/90299861/XL`} />
            <Article title={`격언`} subTitle={<a href="https://namu.wiki/w/워렌%20버핏">워렌 버핏</a>} detail={<Warren />} img1={`https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Warren_Buffett_KU_Visit.jpg/400px-Warren_Buffett_KU_Visit.jpg`} img2={`https://i.namu.wiki/i/hBYwpY9DKjuQ2IV-HTNWkU40lukdsUV9bNzUOSNNthAtn4l5SW69mDQ3NodEJIAHWqzBuU0M4LEL7ayThmnZ0-wXVJTpgdt-etj3mE6jK5A4u7cgammn39l-CDOrNz5Np0Yh8iYii-gzV9Cb7xlXZg.webp`} img3={`https://blog.kakaocdn.net/dn/bjmbIF/btqD2cO6yWX/KznE0noSRyWLuUyPwtPbOK/img.png`} />
